			...
			if (nmapp != null) {
				if (this.output == null) {
					...
					try {
						...
						pw.printf("%n");
						pw.printf("NMICA_WRAPPER=$0%n");
						pw.printf("NMICA_DIR=`dirname $NMICA_WRAPPER`/..%n");
						pw.printf("NMICA_JVM=%s%n", nmapp.vm() == VirtualMachine.SERVER ? "-server" : "-client");
						pw.printf("NMICA_MAINCLASS=%s%n", td.getQualifiedName() + "Application");
						pw.printf("%n");
						pw.printf("if ! [ -e \"${NMICA_DIR}/lib/nmica.jar\" ]; then%n");
